...
module ActiveRecord::Associations
  ...
  class HasOneAssociation
    ...
    #
    def import_portable_association(record_hash, skip_validations, sort_order)
      NotPortableError.raise_on_not_portable(self)
      ...
      proxy_reflection.klass.start_importing do
        proxy_owner.transaction do
          ...
          assoc_record = proxy_reflection.klass.import_from_hash(record_hash, skip_validations, sort_order)
  ...
  class HasManyAssociation
    ...
    #
    def import_portable_association(record_hashes, skip_validations, sort_order)
      NotPortableError.raise_on_not_portable(self)
      ...
      proxy_reflection.klass.start_importing do
        proxy_owner.transaction do
          ...
          assoc_records = record_hashes.map do |record_hash|
            record_hash.merge!(primary_key_hash)
            proxy_reflection.klass.import_from_hash(record_hash, skip_validations, sort_order)
          end
